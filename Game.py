...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load(r'C:\Users\LENOVO\OneDrive\Desktop\Final_Projects\Car_Racing_Game\img\car.png')
    ...
    def display_credit(self):
        ...
        text = font.render("Vivek Kumar", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("kvivek1342@gmail.com", True, self.white)
